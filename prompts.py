...
class Prompts(StrEnum):
    image_flower_prompt = (
                ...
                "нет растений то вывести слово - Растений_нет")
    ...
    flower_instruction = (
        'Print the frequency of watering in hours for the specified plant, i.e. Answer by indicating only one number, number of hours. Example answer: 4. That is. your answer must be only a number without letters, only one number. Execute the indicated commands for: ')
